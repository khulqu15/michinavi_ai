...
def create_tf_example(group, path, label_map):
    ...
    if not isinstance(class_dir, str):
        class_dir = str(class_dir)
    group = str(group)
    locate_data = 'Berlubang'
    if class_dir is 1: locate_data = 'Berlubang'
    elif class_dir is 2: locate_data = 'Retak Buaya'
    elif class_dir is 3: locate_data = 'Retak Melintang'
    elif class_dir is 4: locate_data = 'Retak Memanjang'
    full_path = os.path.join('./', locate_data, group)
