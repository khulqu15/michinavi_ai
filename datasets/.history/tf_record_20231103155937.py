...
def main():
    ...
    train_csv_input = 'datasets/train_labels.csv'
    validation_csv_input = 'datasets/validation_labels.csv'
    train_output_path = 'datasets/train.record'
    validation_output_path = 'datasets/validation.record'
    dataset_path = 'datasets'  # Base directory for the dataset
